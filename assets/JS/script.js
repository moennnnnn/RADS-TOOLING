...
async function updateDashboardStats() {
    try {
        ...
        if (downPaymentsEl && downPaymentsEl.textContent === 'Loading...') downPaymentsEl.textContent = '₱0';
        if (incomingSalesEl && incomingSalesEl.textContent === 'Loading...') incomingSalesEl.textContent = '₱0';
    }
}
