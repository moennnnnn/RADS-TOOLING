...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 03, 2025 at 05:31 AM
...
(47, 'Storage Cabinet', 'Storage Cabinet', 'Elegant storage cabinet', 14000.00, 0, 'uploads/products/cab1_1762143229_6a0de567a9f3.jpg', 'test_cab_1762143256_cd9ff1e3cb08.glb', 'cm', 1, '2025-11-03 04:14:18', 1, 'released', '2025-11-03 12:17:18', 0, NULL);
...
(193, 47, 6, NULL, 0, 0, '2025-11-03 04:17:14');
...
(466, 47, 'width', 200.00, 300.00, 200.00, 1.00, 200.00, 'cm', '2025-11-03 04:17:14', 0.00, 0.00),
(467, 47, 'height', 200.00, 300.00, 200.00, 1.00, 0.00, 'cm', '2025-11-03 04:17:14', 30.00, 100.00),
(468, 47, 'depth', 50.00, 180.00, 50.00, 1.00, 100.00, 'cm', '2025-11-03 04:17:14', 0.00, 0.00);
...
(128, 47, 6, NULL, 0, 0, '2025-11-03 04:17:14');
...
CREATE TABLE `textures` (
  ...
  `allowed_parts` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL CHECK (json_valid(`allowed_parts`)),
  `base_price` decimal(10,2) DEFAULT 0.00,
  `description` text DEFAULT NULL,
  `is_active` tinyint(1) DEFAULT 1,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
