 ...
 * Includes its own CSS automatically.
 */
...
function renderFooter()
{
    ...
    $facebook = $footer['footer_facebook'] ?? 'https://facebook.com'; // Default kung wala
    $copyright = $footer['footer_copyright'] ?? '© 2025 RADS TOOLING INC. All rights reserved.';

    $baseUrl = '';

    // Auto-inject CSS
    echo '<link rel="stylesheet" href="/assets/CSS/footer.css?v=' . time() . '">';
?>
    <footer class="footer">
        <div class="footer-content">
            <div class="footer-section">
                ...
                <div class="footer-social">
                    <?php if (!empty($facebook)): ?>
                        <a href="<?php echo htmlspecialchars($facebook); ?>" class="social-icon" aria-label="Facebook" target="_blank">
                            <img src="/uploads/general/facebook-svgrepo-com.svg" alt="Facebook" class="social-img">
                        </a>
                    <?php endif; ?>
            ...
            <div class="footer-section">
                ...
                <ul class="footer-links">
                    <li><a href="<?php echo $baseUrl; ?>/public/index.php">Home</a></li>
                    <li><a href="<?php echo $baseUrl; ?>/public/about.php">About Us</a></li>
                    <li><a href="<?php echo $baseUrl; ?>/public/products.php">Products</a></li>
                    <li><a href="<?php echo $baseUrl; ?>/public/testimonials.php">Testimonials</a></li>
                    <li><a href="<?php echo $baseUrl; ?>/customer/register.php">Sign Up</a></li>
                    <li><a href="<?php echo $baseUrl; ?>/customer/cust_login.php">Login</a></li>
                </ul>
            </div>
        ...
        <div class="footer-bottom">
            ...
            <div class="footer-legal">
                <a href="<?php echo $baseUrl; ?>/public/privacy.php">Privacy Policy</a>
                <a href="<?php echo $baseUrl; ?>/public/terms.php">Terms & Conditions</a>
            </div>
        </div>
    </footer>
<?php
