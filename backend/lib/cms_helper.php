 ...
 * Works whether called from files with global $pdo or standalone
 */
function getCMSDatabase(): PDO
{
    // Try global $pdo first (from app.php)
    global $pdo;
    if ($pdo instanceof PDO) {
        return $pdo;
    }
    
    // Fallback: Use Database singleton
...
{
    // CHANGED: Use safe database getter instead of global $pdo
    $pdo = getCMSDatabase();
